    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created', models.DateField(blank=True, null=True)),
                ('changed', models.DateField(blank=True, null=True)),
                ('academic_rank_file', models.FileField(blank=True, null=True, upload_to='academicRank/')),
            ],
        ),
        migrations.CreateModel(
            name='Degrees',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('academicDegreeData', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='academic_degree_data_name', to='teachers.academicdegreedata')),
                ('academicRank', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='teachers.ranks', to_field='code')),
                ('academic_rank_data', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='academic_rank_data_name', to='teachers.academicrankdata')),
